	...
	<AppShell active="mall"><view class="page-container">
		...
		<template v-else-if="product">
			<view class="product-layout">
				<view class="card gallery"><image v-if="activeImage" :src="assetUrl(activeImage)" mode="aspectFit"/><view v-else class="placeholder">📦</view></view>
