...
.favorite-page{padding-top:34px}.page-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:22px}.title,.subtitle{display:block}.title{font-size:28px;font-weight:900}.subtitle{margin-top:7px;color:var(--color-text-secondary);font-size:13px}.page-head button{height:36px;padding:0 22px;border:1px solid var(--color-border);border-radius:18px;background:#fff;color:var(--color-text);font-size:12px;line-height:36px}.favorite-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:18px}.product-card{overflow:hidden;cursor:pointer}.product-image{display:block;width:100%;height:190px;background:#fff2e8;object-fit:cover}.placeholder{display:flex;align-items:center;justify-content:center;color:var(--color-primary);font-size:42px;font-weight:900}.product-copy{display:flex;min-height:118px;flex-direction:column;padding:14px}.product-title{font-size:15px;font-weight:800}.product-meta{margin-top:7px;color:var(--color-text-secondary);font-size:11px}.price{margin-top:auto;color:var(--color-primary);font-size:20px;font-weight:900}
