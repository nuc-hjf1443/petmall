...
<style scoped>
.label{display:block;margin:20px 0 10px;font-size:13px;font-weight:700}.topics{display:flex;flex-wrap:wrap;gap:8px}.topics view{padding:7px 12px;border-radius:15px;background:#f5f1ed;color:var(--color-text-secondary);font-size:11px}.topics view.active{background:var(--color-primary-soft);color:var(--color-primary);font-weight:800}.files{display:flex;flex-wrap:wrap;gap:10px}.files view{position:relative;width:90px;height:90px}.files image{width:100%;height:100%;border-radius:10px}.files view>text{position:absolute;top:-6px;right:-6px;display:flex;width:20px;height:20px;align-items:center;justify-content:center;border-radius:50%;background:#333;color:#fff}.files .picker{display:flex;align-items:center;justify-content:center;border:1px dashed var(--color-border);border-radius:10px;color:#aaa;font-size:30px}
</style>
